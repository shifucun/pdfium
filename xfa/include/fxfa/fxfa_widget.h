...
protected:
    ...
    FX_BOOL			ProcessFormatTestValidate(CXFA_Validate validate, FX_BOOL bVersionFlag);
    void			ProcessNullTestValidate(CXFA_Validate validate, FX_INT32 iFlags, FX_BOOL bVersionFlag);
